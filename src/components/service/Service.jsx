        ...
        <article className="service">
          ...
          <ul className="service__list">
            ...
            <li>
              <BsFillPersonCheckFill className="service__list-icon" />
              <p>
                Good Readability and visualization of the text and icons on your
                page
              </p>
            </li>
            <li>
              <BsFillPersonCheckFill className="service__list-icon" />
              <p>
                Consistency of the chosen design; color, animation on your
                entire page
              </p>
            </li>
            <li>
        ...
        <article className="service">
          ...
          <ul className="service__list">
            ...
            <li>
              <BsFillPersonCheckFill className="service__list-icon" />
              <p>
                API call in your React project to communicate with your server
              </p>
            </li>
            <li>
              <BsFillPersonCheckFill className="service__list-icon" />
